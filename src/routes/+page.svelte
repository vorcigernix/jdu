<main class="pt-20 min-h-screen">
		...
		<div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
			...
			>
				<h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">
					Zjisti jestli se
					<br class="hidden lg:inline-block" /><span class="text-lime-500">sejdete</span>
				</h1>
	...
	<section class="body-font hidden">
		<div
		...
		>
			...
			>
				<h1 class="title-font sm:text-4xl text-5xl mb-4 font-bold ">
					Zjisti jestli se <span class="text-lime-500">sejdete</span>!
				</h1>
				<p class="mb-8 leading-relaxed">
					Tahle aplikace slouží k vytvoření opakujících se akcí jako jsou například tréninky.
					Jakmile založíš akci, ostatní se na ní budou moct přihlásit.
				...
				<div class="flex w-full md:justify-start justify-center items-end">
					<a
						href="/new"
						class="h-10 inline-flex text-zinc-900 rounded-full bg-lime-500 border-0 py-2 px-6 focus:outline-none hover:bg-lime-600"
					>
						<span class="text-xl mr-2 font-bold">* </span>Nová událost</a
					>
				</div>
